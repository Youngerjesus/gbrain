 ...
 * (openai/anthropic/google/zeroentropy) into the gateway env, and (b) threading
...
export function buildGatewayConfig(c: GBrainConfig): AIGatewayConfig {
  ...
  if (c.google_generative_ai_api_key) envFromConfig.GOOGLE_GENERATIVE_AI_API_KEY = c.google_generative_ai_api_key;
